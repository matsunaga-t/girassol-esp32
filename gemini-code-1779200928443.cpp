...
String SERVER_URL;  // Preenchida automaticamente no setup()
// ===============================================================
...
void enviarDados() {
    // Aborta e tenta reconectar se não houver Wi-Fi
    ...
    HTTPClient http;
    http.begin(SERVER_URL); // Utilizando a URL montada
...
void setup() {
    ...
    // Monta a URL com o IP configurado globalmente
    SERVER_URL = "http://" + String(SERVER_IP) + ":" + String(SERVER_PORT) + "/dados";
...
void loop(){
    // Garante que o Wi-Fi fique de pé durante o loop
    #if USE_WIFI
